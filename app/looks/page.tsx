...
export default function LooksPage() {
  return <BundleBrowser bundles={getLooksForBrowse()} title="Looks" blurb="Over a thousand complete outfits, curated for taste. Filter by aesthetic, occasion, gender and budget." />;
}
